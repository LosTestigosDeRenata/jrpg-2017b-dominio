...
public class Elfo extends Personaje {
    /**
     * Energia mínima que se necesita para realizar una habilidad.
     */
    ...
    public Elfo(final String nombre, final int salud, final int energia,
		...
		super(nombre, salud, energia, fuerza, destreza, inteligencia, casta,
				experiencia, nivel, idPersonaje, saludTope, energiaTope);
	}
     ...
     * multiplicado por 10
     * @param atacado Instancia de Personaje o de NPC, dependiendo de cual sea,
